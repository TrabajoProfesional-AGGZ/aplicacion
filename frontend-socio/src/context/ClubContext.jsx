 ...
 *
 * El estado arranca con lo que haya cacheado, así que un arranque offline —que en esta PWA es un
 * caso de uso, no un borde— ya pinta la identidad del club en el primer render.
 *
 * **No bloquea el render**, a propósito. Lo único que de verdad depende de esta resolución son
 * las llamadas pre-login, que fallan con su propio error si el club no está; todo lo que pasa
 * después del login se resuelve con el claim del token, que el gateway propaga solo. Poner una
 * pantalla de espera acá rompería justamente el modo offline del carnet: el socio no podría
 * mostrar su QR porque el catálogo de clubes no contestó.
 */
