...
describe('InstalacionesListStep', () => {
  test('muestra el logo animado de carga mientras cargan las instalaciones', () => {
    render(<InstalacionesListStep instalaciones={[]} cargando error={false} onSeleccionar={jest.fn()} />);
    expect(screen.getByRole('status', { name: 'Cargando' })).toBeInTheDocument();
  });

  test('muestra un mensaje de error si falla la carga', () => {
    render(<InstalacionesListStep instalaciones={[]} cargando={false} error onSeleccionar={jest.fn()} />);
  ...
  test('muestra un mensaje vacío cuando no hay instalaciones', () => {
    render(<InstalacionesListStep instalaciones={[]} cargando={false} error={false} onSeleccionar={jest.fn()} />);
  ...
  test('lista cada instalación con nombre, capacidad y precio', () => {
    render(<InstalacionesListStep instalaciones={INSTALACIONES} cargando={false} error={false} onSeleccionar={jest.fn()} />);
  ...
  test('al hacer click en una instalación llama a onSeleccionar con esa instalación', () => {
    ...
    render(<InstalacionesListStep instalaciones={INSTALACIONES} cargando={false} error={false} onSeleccionar={onSeleccionar} />);
